...
export const ArchitecturePage: React.FC = () => {
  return (
    <div className="p-4 max-w-[1750px] mx-auto space-y-5 font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-800 pb-3">
        <div>
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-lg font-bold text-white">Three-Tier System Architecture</h1>
          </div>
      ...
      <div className="bg-[#0F172A] border-2 border-blue-500/80 rounded-lg p-5 text-center shadow-lg">
        <div className="text-[11px] text-white font-bold uppercase tracking-widest mb-1">
          APEX CORE DESIGN PRINCIPLE
        </div>
        <h2 className="text-xl sm:text-2xl font-bold text-white tracking-tight">
          PRESERVE EXISTING INFRASTRUCTURE. ADD A UNIFIED INTELLIGENCE LAYER.
        </h2>
        <p className="text-xs text-slate-200 max-w-2xl mx-auto mt-2 leading-relaxed">
      ...
      <div className="space-y-3 max-w-4xl mx-auto">
        ...
        <div className="bg-[#0F172A] border border-slate-800 rounded-lg p-5 space-y-3 shadow-sm relative">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-xs font-mono">
            <div className="bg-[#0B1120] p-2 rounded border border-slate-800 text-slate-200">
              • ANPR & Plate Search
            </div>
            <div className="bg-[#0B1120] p-2 rounded border border-slate-800 text-slate-200">
              • AI Analytics & Vision
        ...
        <div className="bg-[#0F172A] border border-slate-800 rounded-lg p-5 space-y-3 shadow-sm relative">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs font-mono">
            <div className="bg-[#0B1120] p-2 rounded border border-slate-800 text-slate-200 text-center">
              ONVIF Profile S/G/T
            </div>
            <div className="bg-[#0B1120] p-2 rounded border border-slate-800 text-slate-200 text-center">
      ...
      <div className="bg-[#0F172A] border border-slate-800 rounded-lg p-4 max-w-4xl mx-auto text-xs font-mono flex flex-wrap items-center justify-around gap-4 text-center">
        <div>
          <div className="text-xl font-bold text-blue-400">{STATEWIDE_METRICS.totalCameras}</div>
          <div className="text-slate-400 text-[10px] uppercase">EXISTING CAMERAS IN GUJARAT</div>
        </div>
        <div className="h-8 w-px bg-slate-800 hidden sm:block" />
        <div>
          <div className="text-xl font-bold text-purple-400">{STATEWIDE_METRICS.departmentsCount}</div>
          <div className="text-slate-400 text-[10px] uppercase">PARTICIPATING DEPARTMENTS</div>
        </div>
        <div className="h-8 w-px bg-slate-800 hidden sm:block" />
        <div>
          <div className="text-xl font-bold text-emerald-400">MULTIPLE</div>
          <div className="text-slate-400 text-[10px] uppercase">VMS VENDORS INTEROPERABLE</div>
        </div>
      </div>
    </div>
  );
